...
Estimates are based on CDC 2000 Growth Charts and are for informational purposes only — always consult your pediatrician.
...
npm run ci         # Run tests and build (used in CI)
```
